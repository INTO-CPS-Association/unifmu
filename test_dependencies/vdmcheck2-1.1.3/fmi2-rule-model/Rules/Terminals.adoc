...
-- @DocLink("<FMI2_STANDARD>#section-terminalvars"). Note, from FMI3
// {vdm}
endif::[]
// {vdm}
----
...
-- @DocLink("<FMI2_STANDARD>#_terminal_stream_member_variable"). Note, from FMI3
// {vdm}
endif::[]
// {vdm}
----
...
-- @DocLink("<FMI2_STANDARD>#_terminal_graphical_representation"). Note, from FMI3
// {vdm}
endif::[]
// {vdm}
----
