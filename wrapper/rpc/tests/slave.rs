    ...
    pub fn work(&mut self) -> bool {
        ...
        let response = match command {
            Fmi2Command::Fmi2DoStep {
                ...
                step_size: _,
                no_step_prior: _,
            } => Fmi2Return::Fmi2StatusReturn { status: 0 },
            ...
            Fmi2Command::Fmi2Reset => Fmi2Return::Fmi2StatusReturn { status: 0 },

            Fmi2Command::Fmi2Terminate => Fmi2Return::Fmi2StatusReturn { status: 0 },
            Fmi2Command::Fmi2CancelStep => Fmi2Return::Fmi2StatusReturn { status: 0 },
            Fmi2Command::Fmi2ExtSerializeSlave => Fmi2Return::Fmi2ExtSerializeSlaveReturn {
                status: 0,
                state: vec![0, 0, 0],
            },
            Fmi2Command::Fmi2ExtDeserializeSlave { state: _ } => {
                Fmi2Return::Fmi2StatusReturn { status: 0 }
            }
        };
