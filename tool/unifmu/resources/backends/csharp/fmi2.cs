...
public abstract class Fmi2FMU
{
  ...
  protected IDictionary<UInt32, String> GetReferenceToAttributes()
  {
    ...
    var dict = JsonConvert.DeserializeObject<Dictionary<UInt32, String>>(references_to_values);

    var test = this.GetType().GetProperty("john");
  ...
  public virtual (Fmi2Status, IEnumerable<double>) Fmi2GetReal(IEnumerable<uint> valueReferences)
  {
    try
    {
  ...
  public virtual (Fmi2Status, IEnumerable<int>) Fmi2GetInteger(IEnumerable<uint> valueReferences)
  {
    try
    {
  ...
  public virtual (Fmi2Status, IEnumerable<bool>) Fmi2GetBoolean(IEnumerable<uint> valueReferences)
  {
    try
    {
  ...
  public virtual (Fmi2Status, IEnumerable<string>) Fmi2GetString(IEnumerable<uint> valueReferences)
  {
    try
    {
  ...
  public virtual Fmi2Status FmiSetReal(IEnumerable<uint> valueReferences, IEnumerable<double> values)
  {
    try
    {
  ...
  public virtual Fmi2Status Fmi2SetInteger(IEnumerable<uint> valueReferences, IEnumerable<int> values)
  {
    try
    {
      for (int i = 0; i < valueReferences.Count(); ++i)
  ...
  public virtual Fmi2Status Fmi2SetBoolean(IEnumerable<uint> valueReferences, IEnumerable<bool> values)
  {
    try
    {
      for (int i = 0; i < valueReferences.Count(); ++i)
  ...
  public virtual Fmi2Status Fmi2SetString(IEnumerable<uint> valueReferences, IEnumerable<string> values)
  {
    try
    {
      for (int i = 0; i < valueReferences.Count(); ++i)
  ...
  public virtual Fmi2Status Fmi2DoStep(double currentTime, double stepSize, bool noStepPrior)
  {
    return Fmi2Status.Ok;
  }
