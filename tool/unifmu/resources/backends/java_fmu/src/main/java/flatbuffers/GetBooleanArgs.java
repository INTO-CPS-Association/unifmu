...
public final class GetBooleanArgs extends Table {
  ...
  public static GetBooleanArgs getRootAsGetBooleanArgs(ByteBuffer _bb, GetBooleanArgs obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createGetBooleanArgs(FlatBufferBuilder builder,
  ...
  public static int endGetBooleanArgs(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public GetBooleanArgs get(int j) { return get(new GetBooleanArgs(), j); }
    public GetBooleanArgs get(GetBooleanArgs obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
