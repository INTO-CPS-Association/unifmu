...
public final class GetRealArgs extends Table {
  ...
  public static GetRealArgs getRootAsGetRealArgs(ByteBuffer _bb, GetRealArgs obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createGetRealArgs(FlatBufferBuilder builder,
  ...
  public static int endGetRealArgs(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public GetRealArgs get(int j) { return get(new GetRealArgs(), j); }
    public GetRealArgs get(GetRealArgs obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
